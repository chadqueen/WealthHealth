...
using WealthHealth.Data.Repositories;
using WealthHealth.Data.Repositories.Core;
...
namespace WealthHealth.Data
{
    ...
    public class RepositoryFactories : IRepositoryFactories
    {
        ...
        {
            this.repositoryFactories = this.GetRepositoryFactories();
        }
        ...
        /// <summary>
        /// Get the factory for <see cref="IBaseEntityRepository{T}"/> where T is an entity type.
        /// </summary>
        /// <typeparam name="T">The root type of the repository, typically an entity type.</typeparam>
        /// <returns>
        /// A factory that creates the <see cref="IBaseEntityRepository{T}"/>, given an EF <see cref="DbContext"/>.
        /// </returns>
        /// <remarks>
        ...
        /// <summary>
        /// Default factory for a <see cref="IBaseEntityRepository{T}"/> where T is an entity.
        /// </summary>
