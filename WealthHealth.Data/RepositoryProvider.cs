...
{
    /// <summary>
    /// Provides an <see cref="IBaseEntityRepository{T}"/> for a client request.
    /// </summary>
    /// <remarks>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        /// Get or create-and-cache the default <see cref="IBaseEntityRepository{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        /// Root entity type of the <see cref="IBaseEntityRepository{T}"/>.
        /// </typeparam>
        /// <remarks>
        /// If can't find repository in cache, use a factory to create one.
        /// </remarks>
        public IBaseEntityRepository<T> GetRepositoryForEntityType<T>() where T : class
        {
            return this.GetRepository<IBaseEntityRepository<T>>(
