...
namespace WealthHealth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Manage(ManageUserBindingModel model)
        {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                return View("ExternalLoginConfirmation", new ExternalLoginConfirmationBindingModel { Email = loginInfo.Email });
            }
        }
